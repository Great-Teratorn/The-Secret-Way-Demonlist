...
export default {
    template: `
        <div style="width: 100%; height: calc(100vh - 56px); overflow-y: auto; color: #fff; font-family: sans-serif;">
                        ...
                        <!-- WELCOME PAGE UTILITY WIDGETS HOLDER -->            <div class="welcome-widgets-grid">                                <!-- LEFT SIDE: EXPANDABLE SEARCH BAR WITH LIVE RESULTS FEED -->                <div class="search-widget-column">                    <div class="search-box" id="welcomeSearchBox">                        <input                             type="text"                             id="levelSearch"                             placeholder="Search levels, creators, or players..."                            autocomplete="off"                            oninput="if(window.nativeSearchTyping) window.nativeSearchTyping(this.value)"                            onkeydown="if(event.key==='Enter' && window.nativeSearchEnter) window.nativeSearchEnter(this.value)"                        >                        <button class="search-btn" id="welcomeSearchBtn" onclick="var b=document.getElementById('welcomeSearchBox'); var i=document.getElementById('levelSearch'); if(b&&i){b.classList.toggle('active'); if(b.classList.contains('active')){i.focus();}else{i.value=''; var d=document.getElementById('searchDropdownMenu'); if(d)d.style.display='none';}}">                            <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">                                <circle cx="11" cy="11" r="8"></circle>                                <line x1="21" y1="21" x2="16.65" y2="16.65"></line>                            </svg>                        </button>                                                <!-- DROP MENU SYSTEM HOOKED OUTSIDE STYLING CONTAINER -->                        <div id="searchDropdownMenu" class="search-suggestions-dropdown" style="display: none; position: absolute; top: 45px; left: 0; width: 100%; min-width: 280px; background: #14141c; border: 1px solid rgba(255,255,255,0.2); border-radius: 8px; z-index: 99999999; max-height: 250px; overflow-y: auto;"></div>                    </div>                </div>
                <!-- RIGHT SIDE: RESERVED SPACE FOR WAYBACK MACHINE -->                <div class="wayback-widget-column">                    <div class="wayback-placeholder-text">Wayback Archive Coming Soon...</div>                </div>
            </div>
