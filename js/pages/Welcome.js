            ...
            <div style="margin-bottom: 30px;">
                ...
                <div style="background: rgba(15, 10, 25, 0.6); padding: 25px; border-radius: 8px; border-left: 4px solid #8a2be2; margin-bottom: 35px;">
                    ...
                    <ul style="padding-left: 20px; margin: 0; line-height: 1.7; color: #dde3ea; font-size: 1rem; font-weight: 500;">
                        ...
                        <li>The Weekly Demon List is a weekly challenge where a level out of the top 150 is randomly selected and chosen for that week. Submit a record beating it and gain points on the Weekly Demons Leaderboard! Each week is worth 1 point, so every time you play, your points will accumulate - who are you going to compete with? NOTE: if you have already beaten that level, you must re-beat it for the Weekly Points. Each weekly demon is also declared in our <a href="https://discord.gg/rCEZZA9kZD" target="_blank" rel="noopener noreferrer" style="color: #9023d8; text-decoration: underline; font-weight: bold;">Discord Server</a>.</li>
                        <li>The Leaderboard presents the best secret way players out there! It includes their rank, their points and which levels they have verified or completed. It is split into the Main Leaderboard (Main Demonlist) and the Weekly Demons Leaderboard. Compete with other players in both to attempt to become the #1 Secret Way Player - unlocks a special role in our <a href="https://discord.gg/rCEZZA9kZD" target="_blank" rel="noopener noreferrer" style="color: #9023d8; text-decoration: underline; font-weight: bold;">Discord Server</a>!</li>
                        <li>Clicking the Discord logo in the top purple bar leads you to our <a href="https://discord.gg/rCEZZA9kZD" target="_blank" rel="noopener noreferrer" style="color: #9023d8; text-decoration: underline; font-weight: bold;">Discord Server</a> - please join, there is genuinely so much to do there! If you want any questions answered or want to offer something to our community, this is the place to do so :D</li>
...
<div style="background: rgba(10, 10, 10, 0.75); border: 1px solid rgba(255, 255, 255, 0.1); border-radius: 12px; padding: 25px; margin-top: 40px; margin-bottom: 30px; box-shadow: 0 8px 32px rgba(0, 0, 0, 0.5); backdrop-filter: blur(4px);">
    ...
    <p style="text-align: center; color: #ffffff; font-size: 0.95rem; line-height: 1.6; margin: 0 0 25px 0;">
        ...
        If you need to contact us regarding submissions, list issues, or feedback - please message us directly through our <a href="https://discord.gg/rCEZZA9kZD" target="_blank" rel="noopener noreferrer" style="text-decoration: underline;">Discord Server</a>.
    </p>
